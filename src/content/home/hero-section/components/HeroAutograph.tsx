...
export default function HeroAutograph() {
    return (
        <svg
            ...
            fill="none"
            aria-hidden="true"
            className="xl:w-480 visible pointer-events-none absolute bottom-80 -right-0 transform rotate-5 z-0"
        >
            <motion.path
                ...
                transition={{
                    pathLength: { duration: 1.8, ease: [0.4, 0, 0.2, 1], delay: 2.2 },
            ...
            <motion.path
                ...
                animate={{ pathLength: 1, opacity: 1 }}
                transition={{
                    pathLength: { duration: 0.7, ease: [0.4, 0, 0.2, 1], delay: 3.9 },
                    opacity: { duration: 0.1, delay: 3.9 },
                }}
            />
        </svg>
    )
