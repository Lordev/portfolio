    ...
    return (
            ...
            >
                ...
                <div className='max-lg:self-start flex items-end justify-between xl:pr-132 gap-30 xl:gap-60 2xl:pr-220 lg:pr-78 lg:gap-40'>
                    ...
                    <motion.h1
                        className="text-body-md font-main text-neutral-100 uppercase z-30 text-nowrap max-xs:hidden"
                        variants={revealTagLine}
                        initial="hidden"
                        animate="show"
                    >
                        <motion.div variants={tagLineTextLeft}>
                            Frontend{' '}
                        ...
                        >
                            creating{' '}
                            <span className="font-normal ">digital art</span>{' '}
                        </motion.div>
                    </motion.h1>
                </div>
                ...
                <motion.h1
                        className="text-body-md font-main text-neutral-100 uppercase z-30 text-nowrap xs:hidden self-start mt-16"
                        variants={revealTagLine}
                        initial="hidden"
                        animate="show"
                    >
